const mapa = function mapaResponsive() {
  ...
  function mediaQueries(mq768){
    if(mq768.matches){
      document.body.style.background = '#FC0F2B'
      ...
      document.body.style.background = '#FF570C'

      document.getElementById('Mapa').innerHTML = '<a href="https://goo.gl/maps/J8zQKJXwkMR2" target="_blank">Ver Mapa</a>'
    }
  }
